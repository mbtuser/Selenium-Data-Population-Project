...
public class MBT_Selenium_TestNG_Samples {
    static RemoteWebDriver driver;
    static WebDriverWait waiter;

    static final String url = "https://advantageonlinebanking.com/";
    static final String appName = "Advantage Online Banking";
    ...
    void LoginSiteUser(@Optional("admin") String userName, @Optional("demo") String password) {
        driver.get(url);
        ...
        if (customerDashboard) {
            ...
            Reporter.log("the " + appName + "already in login, need to logout");
        ...
        if (userButton.isDisplayed()) {
            Reporter.log("Login to " + appName + "properly");
        } else {
            Reporter.log("failed to login to " + appName);
        }
    }
    ...
    void Logout() {
        ...
        if (customerDashboard) {
            ...
            Reporter.log("the " + appName + "page is opened in login page");
        }
    }
}
